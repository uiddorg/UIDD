...
CAmount AmountFromValue(const UniValue& value)
{
    ...
    if (dAmount <= 0.000 || dAmount > 210000000000.0)
...
static const CRPCCommand vRPCCommands[] =
    {
       ...
       // {"blockchain", "getinvalid", &getinvalid, true, true, false},
        ...
        /* Uidd features */
        {"uidd", "masternode", &masternode, true, true, false},
        {"uidd", "listmasternodes", &listmasternodes, true, true, false},
        {"uidd", "getmasternodecount", &getmasternodecount, true, true, false},
        {"uidd", "masternodeconnect", &masternodeconnect, true, true, false},
        {"uidd", "masternodecurrent", &masternodecurrent, true, true, false},
        {"uidd", "masternodedebug", &masternodedebug, true, true, false},
        {"uidd", "startmasternode", &startmasternode, true, true, false},
        {"uidd", "createmasternodekey", &createmasternodekey, true, true, false},
        {"uidd", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"uidd", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"uidd", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"uidd", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"uidd", "getmasternodescores", &getmasternodescores, true, true, false},
        {"uidd", "mnsync", &mnsync, true, true, false},
        {"uidd", "spork", &spork, true, true, false},
        {"uidd", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"uidd", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
