...
static Checkpoints::MapCheckpoints mapCheckpoints =
	boost::assign::map_list_of(0, uint256("7306a223fc62b6144b99c68a01ca42a5cd64ab65ae096eff3642ec4ad690511a"))
	(1350, uint256("27e36c38cb706631f5c70910f97aa9e6f89d619e324e360ec797d1f71f12a59d"))
	(15266, uint256("50db1a2d2c1600cd120c78469ffb9dbb152c0589033634a22d36cc311db8f9be"))
	(35852, uint256("fd37629f50d7eba87e69fe8876cd416e33050fa398bcb48050591c9f8ffb8b62"))
	(65850, uint256("46b1d743dc06aa83d2f7efdab40edaab5741366cd75e603b7d38455aaaa7a328"))
	(84502, uint256("def9da6e9b7476922aa776ff1e50d98b096e31fb7075ed4636c318f35906991f"))
	(99111, uint256("36e63a88e7e9ad67bb0d6639c7e3f81e59b3dbc38eca12f35be2418ebf373164"))
	(116322, uint256("bcd5fb698e2a88b27c83187e708bac32fd5774026ec64cdfda6bd0597144862a"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
	1679704101, // * UNIX timestamp of last checkpoint block. obtained by: date +%s.
	236747,    // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        nMaxMoneyOut = 1192000000000 * COIN; // This is the maximum supply.
...
/////////////////////////////////////// */
        assert(hashGenesisBlock == uint256("7306a223fc62b6144b99c68a01ca42a5cd64ab65ae096eff3642ec4ad690511a"));
