...
2. [Sending 1000 Uidd to new wallet addresses.](#option2)
...
### Send 1000 Uidd to New Addresses

Just like setting up a standard MN. Send exactly 1000 Uidd to each new address created above.
...
Copy the masternode private key and correspondig collateral output transaction that holds the 1K Uidd.

The masternode private key may be an existing key from [Option 1](#option1), or a newly generated key from [Option 2](#option2). 

*Please note, the masternode priviate key is not the same as a wallet private key. Never put your wallet private key in the masternode.conf file. That is equivalent to putting your 10,000 Uidd on the remote server and defeats the purpose of a hot/cold setup.*
...
[From the uidd github repo](https://github.com/uidd-crypto/uidd/blob/master/doc/masternode_conf.md)
...
## What about the uidd.conf file?

If you are using a masternode.conf file you no longer need the uidd.conf file. The exception is if you need custom settings (thanks oblox). 

## Update uidd.conf on server

If you generated a new masternode private key, you will need to update the remote uidd.conf files.
